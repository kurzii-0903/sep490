    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
                ...
                .ForMember(dest => dest.Image,
                    otp => otp.MapFrom(src =>
                        (!src.ProductImages.IsNullOrEmpty())
                            ? ($"/images/products/{src.ProductImages.FirstOrDefault().FileName}")
                            : ""))
            ...
            CreateMap<ProductImage, ProductImageResponse>()
                ...
                .ForMember(dest => dest.Image,
                    otp => otp.MapFrom(src => $"/images/products/{src.FileName}"));
            ...
            CreateMap<BlogPost, BlogPostResponse>()
                ...
                .ForMember(dest => dest.ImageUrl,
                    otp => otp.MapFrom(src =>
                        src.FileName != null ? $"/images/blogs/{src.FileName}" : null));
              ...
              .ForMember(dest => dest.ProductImage,
                  otp => otp.MapFrom(src =>
                      (src.Product != null && src.Product.ProductImages != null && src.Product.ProductImages.Any())
                          ? $"/images/products/{src.Product.ProductImages.First().FileName}"
                          : string.Empty
                  ));
            CreateMap<Invoice, InvoiceResponse>()
                ...
                .ForMember(dest=>dest.ImageScreenTransfer,otp=>otp.MapFrom(src=> $"/customer/bills/{src.FileName}"))
