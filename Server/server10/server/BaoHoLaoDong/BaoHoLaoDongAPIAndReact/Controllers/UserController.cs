...
public class UserController : ControllerBase
{
    ...
    public async Task<IActionResult> UpdateInformation([FromBody]UpdateCustomer updateCustomer)
    {
        try
        {
            var cusUpdate = await _userService.UpdateCustomerAsync(updateCustomer);
            if (cusUpdate == null) return NotFound("Not found customer");
