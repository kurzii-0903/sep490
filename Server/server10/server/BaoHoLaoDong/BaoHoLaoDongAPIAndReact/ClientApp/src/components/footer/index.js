...
const Footer = () => {
    ...
    useEffect(() => {
        const fetchBlogs = async () => {
            setLoading(true);
            try {
                const contactResponse = await axios.get(`/api/BlogPost/get-blog-by-category/lien-he`);
                setContactBlogs(contactResponse.data);
                const policyResponse = await axios.get(`/api/BlogPost/get-blog-by-category/chinh-sach`);
                setPolicyBlogs(policyResponse.data);
                const guideResponse = await axios.get(`/api/BlogPost/get-blog-by-category/huong-dan`);
