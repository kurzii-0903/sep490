...
const Checkout = () => {
    ...
    const handleConfirmPayment = async () => {
        try {
            ...
            await axios.put(
                `/api/Invoice/confirm-invoice-by-customer`,
                formData
            );
    ...
    return (
        <PageWrapper title="Thanh toán">
            <div className="checkout-container">
                ...
                {message.show && (
                    <div
                        className={`notification ${message.type === "success" ? "success-message" : "error-message"
                            }`}
                    >
                            ...
                            <div className="checkout-section">
                                ...
                                <div className="payment-info">
                                    <div className="bank-info">
                                        ...
                                        <div className="info-row">
                                            ...
                                            <span className="info-value">{bankNumber}</span>
                                        </div>
                                        <div className="info-row">
                                            <span className="info-label">Số tiền:</span>
                                            <span className="info-value highlight">
                                                {(totalPrice || 0).toLocaleString()}đ
                                            </span>
                                        </div>
                                        <div className="info-row">
                                ...
                                <div className="qr-section">
                                    ...
                                    <div className="qr-code-container">
                                        <img
                                            src={`https://vietqr.co/api/generate/${bankCode}/${bankNumber}/VIETQR.CO/${totalPrice || 0
                                                }/chuyenkhoan`}
                                ...
                                <div className="upload-section">
                                    ...
                                    <p className="upload-instruction">
                                        ...
                                        Vui lòng tải lên ảnh chụp màn hình xác nhận thanh toán để
                                        hoàn tất đơn hàng
                                    </p>
                                        ...
                                        <div key={item.id} className="order-item">
                                            <div className="item-image">
                                                <img
                                                    ...
                                                    alt={item.name || item.variant?.name || "Sản phẩm"}
                                                />
                                            </div>
