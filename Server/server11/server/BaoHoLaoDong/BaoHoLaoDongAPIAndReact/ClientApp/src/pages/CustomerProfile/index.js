...
const CustomerProfile = () => {
    ...
    useEffect(() => {
        ...
        if (user.role !== "Customer") {
            setIsLoading(false); // Không gọi API cho admin/manager
            return;
        }
    ...
    const handleUpdate = async (e) => {
        ...
        if (user.role !== "Customer") {
            setError("Chỉ khách hàng mới có thể cập nhật thông tin");
            return;
        }

        if (formData.phoneNumber && !validatePhoneNumber(formData.phoneNumber)) {
            setError("Số điện thoại phải chứa 9-10 chữ số");
            return;
        }
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    {isLoading ? (
                        ...
                        <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
                            <p className="text-gray-600 text-lg">Không có thông tin dành cho quản trị viên.</p>
                        </div>
                    ) : profile ? (
                                    ...
                                    <form onSubmit={handleUpdate} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={handleInputChange}
                                                pattern="[0-9]{9,10}"
                                                title="Số điện thoại phải chứa 9-10 chữ số"
                                                className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200"
                                            />
                                        </div>
                                        <div>
