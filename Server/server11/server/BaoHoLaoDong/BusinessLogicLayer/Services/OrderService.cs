...
namespace BusinessLogicLayer.Services
{
    public class OrderService : IOrderService
    {
        ...
        private readonly AccountBankOptions _accountBank;
        public OrderService(IOrderRepository orderRepository, IProductRepository productRepository, IUserRepository userRepository,
            ...
            IMailService mailService,IOptions<AccountBankOptions> accountBankOptions)
        {
            ...
            _accountBank = accountBankOptions.Value;
        }
        ...
        private async Task<Order?> CreateOrderEntityAsync(NewOrder newOrder)
        {
            try
            {
                ...
                order.Invoice = new Invoice()
                {
                    ...
                    QrcodeData = $"https://vietqr.co/api/generate/{_accountBank.BankCode}/{_accountBank.AccountNumber}/{_accountBank.AccountName}/{order.TotalAmount}/{invoiceNumber}/chuyenkhoan"
                };
