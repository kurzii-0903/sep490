            ...
            <div className="max-w-5xl mx-auto px-4 py-8">
                <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div className="p-8 text-center">
                        ...
                        <h2 className="text-2xl font-bold text-gray-800 mb-4">Cảm ơn bạn đã đặt hàng!</h2>
                        ...
                        <div className="bg-gray-50 p-6 rounded-lg mb-6">
                            ...
                            <p className="text-gray-600">Họ tên: {customerInfo.customerName}</p>
                            <p className="text-gray-600">Số điện thoại: {customerInfo.customerPhone}</p>
                            <p className="text-gray-600">Địa chỉ: {customerInfo.customerAddress}</p>
                            <p className="text-gray-600">
                                Phương thức thanh toán: {customerInfo.paymentMethod === "Cash" ? "Tiền mặt" : "Thanh toán online"}
                            </p>
                            <p className="font-medium text-gray-800 mt-2">Tổng tiền: {formatVND(totalAmount)}</p>
                        </div>
                                ...
                                {orderData.orderDetails.map((item, index) => (
                                    <tr key={`${item.productId}-${index}`} className={index % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                                        ...
                                        <td className="py-4 px-4 text-center border-b">
                                            {item.variant ? (
                                                <div className="flex items-center justify-center">{item.variant.color}</div>
                                            ) : (
                                                "N/A"
                                            )}
                                        </td>
