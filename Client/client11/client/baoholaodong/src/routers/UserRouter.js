...
import {
  ...
  Products,
  UpdateProduct,
} from "../pages/manager/ProductManager";
import {
  UpdateBlogs,
  CreateBlogs,
  BlogPosts,
} from "../pages/manager/BlogManager";
    ...
    <Router>
      ...
      <Routes>
        ...
        >
          <Route
            path="/feedback/:slug"
            element={<FeedBack config={config} />}
          />
          ...
          <Route
            path="confirm-order"
            element={<ConfirmOrder config={config} />}
          />
          <Route path="/checkout" element={<Checkout config={config} />} />
          <Route
            path="/verification"
            element={<VerificationPage config={config} />}
          />
          <Route path="/logout" element={<Logout config={config} />} />
          <Route path="/contact" element={<Contact config={config} />} />
          <Route
            path="/customerInfo"
            element={<CustomerInfo config={config} />}
          />
          <Route
            path="/products/:group/:cate/:slug"
            element={<ProductListByCategory config={config} />}
          />
          <Route
          ...
          <Route
            path="/order-history"
            element={<OrderHistory config={config} />}
          />
        </Route>
        {/* Admin Routes */}
        <Route
            ...
            <AdminProductProvider config={config}>
              <BlogPostProvider config={config}>
                <AdminUserContextProvider config={config}>
                  <PrivateRoute
                    element={<AdminLayout config={config} />}
        ...
        >
          ...
          <Route
            ...
            element={
              <PrivateRoute
                element={<Employees config={config} />}
                roleRequired={["Admin"]}
              />
            }
          />
          <Route
            ...
            element={
              <PrivateRoute
                element={<CreateEmployee config={config} />}
                roleRequired={["Admin"]}
              />
            }
          />
          <Route
            ...
            element={
              <PrivateRoute
                element={<UpdateEmployee config={config} />}
                roleRequired={["Admin"]}
              />
            }
          />
          ...
          <Route
            ...
            element={
              <PrivateRoute
                element={<CreateOrder config={config} />}
                roleRequired={["Admin"]}
              />
            }
          />
          <Route
            ...
            element={
              <PrivateRoute
                element={<OrderDetail config={config} />}
                roleRequired={["Admin"]}
              />
            }
          />
          ...
          <Route
            ...
            element={
              <PrivateRoute
                element={<BlogPosts config={config} />}
                roleRequired={["Admin", "Manager"]}
              />
            }
          />
          <Route
            ...
            element={
              <PrivateRoute
                element={<CreateBlogs config={config} />}
                roleRequired={["Admin", "Manager"]}
              />
            }
          />
          <Route
            ...
            element={
              <PrivateRoute
                element={<UpdateBlogs config={config} />}
                roleRequired={["Admin", "Manager"]}
              />
            }
          />
          <Route
            ...
            element={
              <PrivateRoute
                element={<Invoices config={config} />}
                roleRequired={["Admin"]}
              />
            }
          />
          <Route
            ...
            element={
              <PrivateRoute
                element={<Notifications config={config} />}
                roleRequired={["Admin"]}
              />
            }
          />
          <Route
            ...
            element={
              <PrivateRoute
                element={<Settings config={config} />}
                roleRequired={["Admin", "Manager"]}
              />
            }
          />
          <Route
            ...
            element={
              <PrivateRoute
                element={<CreateProduct config={config} />}
                roleRequired={["Admin"]}
              />
            }
          />
          <Route
            path="update-product/:id/:slug"
            element={
              <PrivateRoute
                element={<UpdateProduct config={config} />}
                roleRequired={["Admin"]}
              />
            }
          />
          <Route
            ...
            element={
              <PrivateRoute
                element={<ProductCategories config={config} />}
                roleRequired={["Admin", "Manager"]}
              />
            }
          />
          <Route
            ...
            element={
              <PrivateRoute
                element={<BlogCategories config={config} />}
                roleRequired={["Admin", "Manager"]}
              />
            }
          />
