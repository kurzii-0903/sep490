...
export default function OrderDetail() {
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                {Array(6)
                                    .fill(0)
                                    .map((_, i) => (
                                        <div key={i} className="h-6 w-full mt-4 bg-gray-200 rounded animate-pulse"></div>
                                    ))}
                            </div>
                            <div>
    ...
    // Get the image URL for the invoice
                ...
                <div className="p-4 md:p-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-6">
                                ...
                                <div className="p-4">
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <span className="font-medium">{order.totalAmount.toLocaleString()} VND</span>
                                        </div>
                                        <div className="flex justify-between">
                                ...
                                <div className="p-4">
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <span className="font-medium">{order.invoice.amount.toLocaleString()} VND</span>
                                        </div>
                                        <div className="flex justify-between">
                                        ...
                                        <div className="flex justify-between">
                                            <span className="text-gray-500">Trạng thái:</span>
                                            <span className="font-medium">{order.invoice.paymentStatus}</span>
                                        </div>
                                        <div className="flex justify-between">
                                            <span className="text-gray-500">Ngày tạo:</span>
                                            <span className="font-medium">{new Date(order.invoice.createdAt).toLocaleString()}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                                <div className="p-4 border-b border-gray-200">
                                    <h2 className="text-lg font-semibold text-gray-800">Hình ảnh hóa đơn</h2>
                                </div>
                                <div className="p-4">
                                    {order.invoice && order.invoice.invoiceNumber ? (
                                        <div className="border border-gray-200 rounded-md overflow-hidden">
                                            <div className="relative min-h-[200px] flex items-center justify-center">
                                                ...
                                                {/* Image with onLoad and onError handlers */}
                                                <img
                                                    src={getInvoiceImageUrl(order.invoice.invoiceNumber) || "/placeholder.svg"}
                              ...
                              `
                                                            ...
                                                            errorDiv.querySelector("button").addEventListener("click", () => {
                                                                ...
                                                                target.src = `${getInvoiceImageUrl(order.invoice.invoiceNumber)}&t=${timestamp}`
                                    ...
                                    <div className="overflow-x-auto">
                                        <table className="w-full border-collapse">
                                            ...
                                            <tr className="bg-gray-50 text-sm">
                                                <th className="border border-gray-200 px-3 py-2 text-left">Ảnh sản phẩm</th>
                                                <th className="border border-gray-200 px-3 py-2 text-left">Sản phẩm</th>
                                                <th className="border border-gray-200 px-3 py-2 text-right">Giá</th>
                                                <th className="border border-gray-200 px-3 py-2 text-center">SL</th>
                                                <th className="border border-gray-200 px-3 py-2 text-right">Thành tiền</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            {order.orderDetails.map((item) => (
                                                <tr key={item.orderDetailId} className="hover:bg-gray-50">
                                                    <td className="border border-gray-200 px-3 py-2">
                                                        <img src={item.productImage} key={item.productId} width={'50px'}/>
                                                    </td>
